...
bstSparse_Dense <- xgb.train(data = dtrain, max.depth = 2, eta = 0.04, nthread = 10, nround = 5000, max_delta_step = 10, lambda = 100,tree_method='exact', watchlist = watchlist, objective = "reg:linear")
...
bstSparse_lBoost <- xgb.train(data = dtrain, max.depth = 2, booster = "gbtree", nthread = 10, nround = 5000, watchlist = watchlist, objective = "reg:linear")
...
#------------selecting 15 important features from xgboost---
